...
function CategoryCard({ category }) {
  ...
  return (
    <div 
      ...
      className="group relative flex flex-col bg-white dark:bg-gray-900/50 rounded-2xl overflow-hidden border border-gray-200 dark:border-indigo-500/10 hover:border-indigo-500/40 transition-all duration-500 hover:-translate-y-2 cursor-pointer shadow-lg hover:shadow-[0_20px_50px_rgba(79,70,229,0.2)]"
    >
      ...
      <div className="relative aspect-16/10 overflow-hidden bg-gray-100 dark:bg-[#0B0F1A]">
        ...
        />
        <div className="absolute inset-0 bg-linear-to-t from-white dark:from-[#121826] via-transparent to-transparent opacity-80" />
      </div>

      <div className="p-6 relative z-10">
        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2 group-hover:text-indigo-400 transition-colors">
          {category.name}
        </h3>
